...
| Name | Description | Sample? | NPM |
| ---- | ----------- | ------- | --- |
| [@botbuildercommunity/adapter-alexa](libraries/botbuilder-adapter-alexa/README.md) | A platform adapter for Amazon Alexa | | [![NPM Version](https://img.shields.io/npm/v/@botbuildercommunity/adapter-alexa.svg)](https://www.npmjs.com/package/@botbuildercommunity/adapter-alexa) |
